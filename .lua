...
# ██║░╚███║██║╚██████╔╝╚██████╔╝██║░░██║██╗███████╗╚█████╔╝███████╗ # 
# ╚═╝░░╚══╝╚═╝░╚═════╝░░╚═════╝░╚═╝░░╚═╝╚═╝╚══════╝░╚════╝░╚══════╝ # 
#  Dont be a poor nigga 2024 - "SON" skid of nation                 #                                                   
#####################################################################
Spear is poor lol
       Spear owns 100% of this copy skidded shitty ass script lol
                                                                                ]]
...
gui.TextLabel_1.TextColor3 = Color3.new(0.000000, 0.047059, 0.694118)
gui.TextLabel_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
gui.TextLabel_1.Text = "     .lol v1.2.3"
gui.TextLabel_1.BackgroundTransparency = 1
gui.TextLabel_1.Parent = gui.Frame

gui.signin_load.BorderSizePixel = 0
gui.signin_load.BackgroundColor3 = Color3.new(0.000000, 0.007843, 0.439216)
...
gui.signin_load.Text = "Use Cheat"
...
gui.TextLabel_2.Text = "       I love cheating <3"
...
gui.fps_checkbox.BackgroundColor3 = Color3.fromRGB(0.000000, 0.007843, 0.439216)
...
gui.fpscheckbox_button.MouseButton1Click:Connect(function()
	if gui.fps_checkbox.BackgroundColor3 == Color3.new(0.011765, 0.000000, 0.760784) then
	...
	elseif gui.fps_checkbox.BackgroundColor3 == Color3.fromRGB(20,20,20) then
		...
		gui.fps_checkbox.BackgroundColor3 = Color3.new(0.000000, 0.019608, 0.321569)
...
gui.blazedLoader:Destroy()
    ...
    local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
        ...
        Library:SetWatermark(('Nigger.lol | @11c | %s ms'):format(
            math.floor(FPS),
    ...
    Notifications("Esexed in "..string.format("%.2f", tostring(tick() - loadingtime,nil))..tostring(" Seconds"))
    loadingtime = nil
    
    else
    
    
    Notifications("Yo Its Nigger.Lol!");
    ...
    gui.Frame_1.BackgroundColor3 = Color3.new(0.000000, 0.094118, 0.513725)
    gui.Frame_1.Parent = gui.Frame
    
    gui.TextLabel_1.TextStrokeTransparency = 0
    gui.TextLabel_1.BorderSizePixel = 0
    gui.TextLabel_1.BackgroundColor3 = Color3.new(0.007843, 0.000000, 0.486275)
    ...
    gui.Frame_2.BackgroundColor3 = Color3.new(0.000000, 0.047059, 0.454902)
    ...
    local Window = Library:CreateWindow({
        Title = 'Nigger.lol | developer mode',
        Center = true, 
        AutoShow = true,
        Size = UDim2.fromOffset(550, 560),
        TabPadding = 4,
...
gv = false
    ...
    Notifications("Sex ended "..string.format("%.2f", tostring(tick() - loadingtime,nil))..tostring(" Seconds"))
    loadingtime = nil
    end
